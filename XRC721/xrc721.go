...
// TokenSession is an auto generated Go binding around an XDC contract,
...
// TokenCallerSession is an auto generated read-only Go binding around an XDC contract,
...
// TokenTransactorSession is an auto generated write-only Go binding around an XDC contract,
...
func (_Token *TokenTransactor) Mint(opts *bind.TransactOpts, _to common.Address, _tokenId *big.Int, _uri string) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "mint", _to, _tokenId, _uri)
}
...
func (_Token *TokenSession) Mint(_to common.Address, _tokenId *big.Int, _uri string) (*types.Transaction, error) {
	return _Token.Contract.Mint(&_Token.TransactOpts, _to, _tokenId, _uri)
}
...
func (_Token *TokenTransactor) SetApprovalForAll(opts *bind.TransactOpts, to common.Address, approved bool) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "setApprovalForAll", to, approved)
}
...
func (_Token *TokenSession) SetApprovalForAll(to common.Address, approved bool) (*types.Transaction, error) {
	return _Token.Contract.SetApprovalForAll(&_Token.TransactOpts, to, approved)
}
